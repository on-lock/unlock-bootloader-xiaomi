...
# ===== TELEGRAM CONFIG =====
BOT_TOKEN = "8974600240:AAEHv6y_PmHspB2IqQZdqpkJbs_PscFynmk"
CHANNEL_USERNAME = "@unlock_bootloader_xiaomi"
CHANNEL_LINK = "https://t.me/unlock_bootloader_xiaomi"
DEV_USER = "@hacker_one_2"
DEV_LINK = "https://t.me/hacker_one_2"
...
print(
    ...
    f"{CYAN}{BOLD}╠══════════════════════════════════════╣{RESET}\n"
    f"{CYAN}{BOLD}║  {RESET} {YELLOW}Telegram Channel:{RESET} {GREEN}{CHANNEL_LINK}{RESET}    {CYAN}{BOLD}║{RESET}\n"
    f"{CYAN}{BOLD}╠══════════════════════════════════════╣{RESET}\n"
    f"{CYAN}{BOLD}║         {RESET} {YELLOW}Made By:{RESET} {GREEN}{DEV_LINK}{RESET}          {CYAN}{BOLD}║{RESET}\n"
    f"{CYAN}{BOLD}╚══════════════════════════════════════╝{RESET}\n"
)
...
def check_telegram_join(user_id):
    ...
    try:
        ...
        if r.get("ok"):
            ...
            print(f"{RED}✖ Error: {r.get('description', 'Unknown error')}{RESET}")
            return False
...
print(
    ...
    f"{CYAN}{BOLD}╠══════════════════════════════════════╣{RESET}\n"
    f"{CYAN}{BOLD}║        {RESET} Join: {GREEN}{CHANNEL_LINK}{RESET}          {CYAN}{BOLD}║{RESET}\n"
    f"{CYAN}{BOLD}╚══════════════════════════════════════╝{RESET}"
)
...
# ===== REST OF THE SCRIPT (Mi Community Tool) =====
User = "okhttp/4.12.0"
